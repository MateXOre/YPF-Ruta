...
use crate::actores::gestor::messages::{ModificarLimiteGeneral, ModificarLimiteParticular};
...
impl Handler<ModificarLimiteParticular> for Gestor {
    ...
    fn handle(&mut self, msg: ModificarLimiteParticular, _ctx: &mut Context<Self>) -> Self::Result {
        self.modificar_limite_particular_tarjeta(msg.id_tarjeta, msg.nuevo_limite)
    }
}